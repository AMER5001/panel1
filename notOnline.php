...
<body>
  ...
  <div class="app layout-fixed-header usersession">
    <div class="full-height">
      <div class="center-wrapper text-center">
        <div class="center-content">
          <div class="error-number" style="color: red;">
            <i class="fa fa-warning show"></i>
            <span>404</span>
          </div>
          <div class="mb15 mt15">انت غير متصل قم بالدخول للتيم سبيك ثم اعادة تحديث الصفحة</div>
        </div>
      </div>
